...
../react-smooth/src is a animation library work on React.

[![npm version](https://badge.fury.io/js/../react-smooth/src.png)](https://badge.fury.io/js/../react-smooth/src)
[![build status](https://travis-ci.org/recharts/../react-smooth/src.svg)](https://travis-ci.org/recharts/../react-smooth/src)
[![npm downloads](https://img.shields.io/npm/dt/../react-smooth/src.svg?style=flat-square)](https://www.npmjs.com/package/../react-smooth/src)
[![Gitter](https://badges.gitter.im/recharts/../react-smooth/src.svg)](https://gitter.im/recharts/../react-smooth/src?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge)

## install
```
npm install --save ../react-smooth/src
```
